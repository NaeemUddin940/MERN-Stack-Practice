      ...
      {context.isOpen && (
        <>
          <motion.div
            ...
            aria-modal='true'
            className={cn(
              'absolute overflow-hidden z-1 rounded-md border border-zinc-950/10 bg-white p-2 text-zinc-950 shadow-md dark:border-zinc-50/10 dark:bg-zinc-700 dark:text-zinc-50',
              className
            )}
            initial='initial'
            animate='animate'
