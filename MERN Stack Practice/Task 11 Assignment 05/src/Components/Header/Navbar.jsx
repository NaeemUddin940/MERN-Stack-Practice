...
const Navbar = () => {
  return (
    <div>
      <div className="flex bg-base-100 shadow-sm lg:px-20 md:px-10 sm:px-5">
        ...
        <div className="navbar-end">
          ...
          <div className="pl-5 relative">
            ...
            <div id="cart" className="bg-red-400 absolute -top-1 -right-1 h-4 w-4 flex justify-center items-center rounded-full">
